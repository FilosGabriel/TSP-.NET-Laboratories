...
using AutoMapper;
using Laborator6.APIDto;
using Laborator6.DTO;

namespace Laborator6.APIDtoStatic
{
    ...
    internal class ServicePost
    {
        ...
        public bool DeleteComment(Comment id)
        {
            return false;
        }
        ...
        public Comment SubmitComment(int id, Comment comment)
        {
            return null;
        }
        ...
        public Comment GeCommentByTitle(string til)
        {
            return null;
        }
